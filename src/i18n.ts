...
const ui = {
  fr: {
    ...
    "product.perk1": "Échantillon offert pour l'achat d'un parfum",
    "product.perk2": "Livraison offerte avec Colissimo & DHL",
    "product.perk3": "Une petite attention à chaque commande",
  ...
  ar: {
    ...
    "product.perk1": "عيّنة مجانية عند شراء عطر",
    "product.perk2": "توصيل مجاني عبر Colissimo و DHL",
    "product.perk3": "هدية صغيرة مع كل طلب",
  ...
  en: {
    ...
    "product.perk1": "Free sample with any perfume purchase",
    "product.perk2": "Complimentary delivery with Colissimo & DHL",
    "product.perk3": "A little treat with every order",
